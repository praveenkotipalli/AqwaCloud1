    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-4">Google Drive Integration Test</h1>
          <p className="text-slate-300 text-lg">
            Test the real-time Google Drive file browsing and authentication
          </p>
        </div>
        ...
        <Card className="bg-blue-500/10 border-blue-500/20">
          ...
          <CardContent className="space-y-2 text-blue-300">
            <p>1. Click "Connect" on Google Drive in the Connection Manager</p>
            <p>2. You'll be redirected to Google's OAuth page</p>
            <p>3. Grant permissions to AqwaCloud</p>
            <p>4. You'll be redirected back and can browse your real Google Drive files</p>
